...
function SideBar({ inORex }) {
  return (
    <div className=" xl:h-[800px]  mb-8 xl:mb-0  font-body font-semibold container bg-customGreen w-5/6 md:w-11/12 xl:w-52     rounded-[56px]  p-4 md:p-2 flex   items-center ">
      <div
        id="buttons"
